		...
		<form method="#">
			...
			<table border="1" align="left">
				...
				<tr>
					...
					<td><input id="googleLatitude" name="googleLatitude"
						type="text" value="" ng-model="googleLatitude"></td>
				</tr>

				<tr>
					<td><label for="googleLongitude">Longitude</label></td>
					<td><input id="googleLongitude" name="googleLongitude"
						type="text" value="" ng-model="googleLongitude"></td>
				...
				<tr>
					...
					<td><input id="fax" name="fax" type="text" value=""
						ng-model="fax"></td>
				</tr>
				...
				<tr>
					...
					<td><input id="imageAlt" name="imageAlt" type="text" value=""
						ng-model="imageAlt"></td>
					<td></td>
					<td></td>
				</tr>
				...
				<tr>
					<td></td>
					<td><input type="button" value="Save Contact" name="submit"
						id="submit" value="Submit" ng-click="saveContact($event);"></td>
					<td></td>
					<td></td>
				</tr>
			...
			<table ng-show="contactList.length > 0">
				...
				<tbody>
					<tr ng-repeat="contact in contactList track by $index">
						<td style="text-align: center;">Type:{{contact.contactType
							}}&nbsp;</td>
